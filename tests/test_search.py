...
def test_qa_and_reference_cards_are_retrievable_with_their_usage_status() -> None:
    service = KnowledgeService()
    result = service.list_captures("Candrive", top_k=5)
    ...
    evidence = service.get_evidence("Candrive 5.26배", top_k=5)
    ...
    reference = service.get_evidence("Harms route familiarity 94편", top_k=5)
    ...
    ji = service.get_evidence("Ji mobility regularity", top_k=5)
    ...
    statistics = service.get_evidence("Statistics Korea 2025", top_k=5)
