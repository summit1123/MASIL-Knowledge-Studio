...
async def test_open_items_reports_exact_total_for_each_scope() -> None:
    ...
    async with Client(server) as client:
        ...
        assert unresolved.structured_content["total_count"] == 17
        assert unresolved.structured_content["returned_count"] == 17
        assert unresolved.structured_content["status_counts"] == {"unresolved": 17}
        ...
        assert all_open.structured_content["total_count"] == 30
        assert all_open.structured_content["returned_count"] == 30
